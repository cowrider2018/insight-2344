...
| 30 | EXP-030 | 橫斷面相對強弱・中期尺度：目標改為未來5/10日相對報酬（不重疊區塊），訊號用慢變數(20日相對動能/10日累積法人相對流/集保大戶相對變化)；若成立作為日報「相對強弱週期」說明軸 | already-local（xs.db 2y＋xs_tdcc 1y） | REJECT |
...
| EXP-030 | REJECT | 5日全擲幣(p≥0.82)；10日flow_rel反向train/test符號翻轉、tdcc_rel train90%→test41.67%崩潰＝小樣本過擬合；選項1全尺度關閉 | [EXP-030](docs/experiments/EXP-030-xs-medium-horizon.md) |
...
| 橫斷面相對強弱・中期尺度（5/10日 horizon，慢變數：相對動能/累積相對流/大戶相對變化） | EXP-030：5日全擲幣；10日兩個訊號狀形態皆 train/test 翻轉或崩潰＝雜訊 | 無（除非新增產品線級資料，如利基型 DRAM 報價分離數列） |
